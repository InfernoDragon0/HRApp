<template>
    ...
    <a-tab-pane key="1" tab="Payrolls">
        <a-typography-title>Your Previous Payrolls</a-typography-title>
        <a-typography-text type="secondary">Here you can view your previous payrolls, and download them</a-typography-text>
